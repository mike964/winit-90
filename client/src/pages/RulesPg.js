    ...
    <div dir='rtl' className="text-r w-75 m-auto curved bg-shadow p-3 curved-6 box">
      <Tabs defaultActiveKey="weeklycontest" id="uncontrolled-tab-example">
        ...
        <Tab eventKey="weeklycontest" title="المسابقة الاسبوعیة" className='p-3' tabClassName='goldd'>
          <div className="x">
            <ul>
              <p> <i className="fas fa-hand-point-left fr p-2" />کل ما علیک هو اختیار الفریق الذی تتوقع سیفوز في کل مباراة بالضغط علی شعار الفریق، ثم تعیین اختلاف الاهداف باستخدام العداد</p>
        ...
        <Tab eventKey="vipcontest" title="المسابقة الذهبیة" className='p-3'>
          <ul>
            <li className="x">
